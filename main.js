...
function activateMenuAtCurrentSection() {
  ...
  const checkpoint = window.pageYOffset + (window.innerHeight / 8) * 4
    /* offset significa deslocamento e é do eixo Y, além de pegar o deslocamento eu coloquei o + para dividir 
    a   minha janela em 8 (o numero que eu coloquei) e multipliquei */
